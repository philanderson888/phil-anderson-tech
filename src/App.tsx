...
import { Server, Cloud, Code, Cpu, Users, Terminal, ArrowRight, Phone, Mail, Linkedin, Github } from 'lucide-react';
      ...
      <header className="relative h-screen">
        ...
        <nav className="relative z-10 container mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            <div className="text-white text-2xl font-bold">PhilAnderson Tech</div>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-2xl font-bold mb-4 md:mb-0">PhilAnderson Tech</div>
